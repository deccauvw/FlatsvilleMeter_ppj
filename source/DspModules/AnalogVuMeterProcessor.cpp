...
{
    auto calibrationGain = juce::Decibels::decibelsToGain(-1.0f * DspLine::Constants::kVuReferenceCalibrationDb);
    rawBuffer.applyGain(calibrationGain); // 300mV sat point when buffer hits `1.0f`
